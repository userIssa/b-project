        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border border-white/10">
            ...
            <div className="border border-white/10 p-8 space-y-3">
              <MapPin className="w-6 h-6 text-[#a05c1e]" />
            ...
            <div className="border border-white/10 p-8 space-y-3">
              <Phone className="w-6 h-6 text-[#a05c1e]" />
              <h3 className="font-serif text-lg font-bold text-white">Direct Line</h3>
              <p className="text-xs text-white/50 font-sans leading-relaxed">
                Tel: +234 (0) 800 B-PROJECTS<br />
                Office: +234 (0) 1 234 5678
              </p>
            </div>

            <div className="border border-white/10 p-8 space-y-3">
              <Mail className="w-6 h-6 text-[#a05c1e]" />
              <h3 className="font-serif text-lg font-bold text-white">Email Inquiries</h3>
              <p className="text-xs text-white/50 font-sans leading-relaxed">
                info@b-projectsventures.com<br />
                procurement@b-projectsventures.com
              </p>
            </div>

            <div className="border border-white/10 p-8 space-y-3">
              <Clock className="w-6 h-6 text-[#a05c1e]" />
              <h3 className="font-serif text-lg font-bold text-white">Working Hours</h3>
              <p className="text-xs text-white/50 font-sans leading-relaxed">
                Mon – Fri: 8:00 AM – 5:30 PM WAT<br />
                Sat – Sun: Closed
              </p>
            </div>
